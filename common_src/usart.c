...
extern uint16_t TxLedCounter;
extern uint16_t RxLedCounter;
#define LED_COUNT_NUM 50
...
void USART_mySetLineCodingHandler(void)
{
    ...
    uint32_t dwBaud = ((GetSystemClock()/4) / line_coding.dwDTERate) - 1;
