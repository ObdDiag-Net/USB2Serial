...
#define UART_TRISTx   TRISCbits.TRISC4 // TRISBbits.TRISB7
#define UART_TRISRx   TRISCbits.TRISC5 //TRISBbits.TRISB5
#define UART_Tx       PORTCbits.RC4 // PORTBbits.RB7
#define UART_Rx       PORTCbits.RC5 // PORTBbits.RB5

// Use following only for Hardware Flow Control
#define UART_DTS PORTAbits.RA3  // Not used if not defined USB_CDC_SUPPORT_DSR_REPORTING
#define UART_DTR LATCbits.LATC3 // Not used if not defined USB_CDC_SUPPORT_DSR_REPORTING
#define UART_RTS LATBbits.LATB4 // Not used if not defined USB_CDC_SUPPORT_DSR_REPORTING
#define UART_CTS PORTBbits.RB6  // Not used if not defined USB_CDC_SUPPORT_DSR_REPORTING
...
/******************************************************************************
 * Function:        uint8_t USART_getcUSART()
 *
 * PreCondition:    None
 *
 * Input:           None
 *
 * Output:          uint8_t c - character to received on the UART
 *
 * Side Effects:    None
 *
